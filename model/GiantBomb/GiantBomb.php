<?php
    ...
    class GiantBomb {
        ...
        public function random_game(){
            $rand_query = $this->games(null, 1, 0, null, null, array('id'));
            $number_of_total_results = $rand_query->number_of_total_results;

            return $this->games(null, 1, rand(0,$number_of_total_results), null, null, array('id', 'name', 'image'));
